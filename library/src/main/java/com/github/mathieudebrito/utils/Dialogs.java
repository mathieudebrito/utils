...
public class Dialogs {
    ...
    public static Dialog rate(Context context, String title, int defaultValue, final DialogRateListener listener) {
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(context)
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    @Override
                    public void onPositive(MaterialDialog dialog) {
                        RatingBar rtbRating = (RatingBar) dialog.getCustomView().findViewById(R.id.rtbRating);
                        listener.onRateChanged((int) rtbRating.getRating());
                    }
        ...
        RatingBar rtbRating = (RatingBar) dialog.getCustomView().findViewById(R.id.rtbRating);
        rtbRating.setRating(defaultValue);
